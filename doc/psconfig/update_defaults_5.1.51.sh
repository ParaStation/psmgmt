...
psconfig -q -D -- setList 'defaults:psid' 'AvailableHardwareTypes' 'booster' 'cluster' 'ethernet' 'gateway' 'p4sock' 'accounter' 'mvapi' 'openib' 'ipath'
...
psconfig -q -D -- setList 'defaults:psid' 'HardwareTypes' 'ethernet' 'p4sock'
