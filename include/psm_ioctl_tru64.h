...
#define PSHAL_DUMPSRAM		_IOWR(PSHAL_GROUP,101,int)
//#define PSHAL_GETCOUNT		_IOR(PSHAL_GROUP,0,PSHAL_COUNT)
/* register a new mcp */
#define PSHAL_REGMCP		_IOW(PSHAL_GROUP,102,PSHALMCPDef_t)
#define PSHAL_LOADMCP		_IOW(PSHAL_GROUP,103,PSHAL_MCP_CNAME)
#define PSHAL_GETRTC            _IOR(PSHAL_GROUP,104,int)
#define PSHAL_GETISR            _IOR(PSHAL_GROUP,105,int)
#define PSHAL_GETMCPNAME	_IOWR(PSHAL_GROUP,106,PSHAL_MCP_CNAME)
#define PSHAL_RELOADMCP		_IO(PSHAL_GROUP,107)
#define PSHAL_NOP		_IO(PSHAL_GROUP,108)
#define PSHAL_GETSREG           _IOR(PSHAL_GROUP,109,int)
...
#define PSHAL_MCP_GETTRACE	_IOR(PSHAL_GROUP,205,PSHALMCPTrace_t)
#define PSHAL_MCP_OPEN_CONTEXT	_IO(PSHAL_GROUP,206)
#define PSHAL_MCP_PORT_BIND	_IOWR(PSHAL_GROUP,207,PSHALMCPPortBind_t)
#define PSHAL_MCP_PORT_DELETE	_IOWR(PSHAL_GROUP,208,PSHALMCPPortBind_t)
#define PSHAL_MCP_SET_ROUTES	_IOWR(PSHAL_GROUP,209,PSHALSYSRoutings_t)
//#define PSHAL_MCP_GET__ROUTES	_IOR(PSHAL_GROUP,210,PSHALSYSRoutings_t)
#define PSHAL_MCP_SET_PARAM	_IOWR(PSHAL_GROUP,211,PSHALMCPParam_t)
#define PSHAL_MCP_GET_PARAM	_IOR(PSHAL_GROUP,212,PSHALMCPParam_t)
#define PSHAL_MCP_SLEEP_ON_PORT _IOW(PSHAL_GROUP,213,PSHALMCPSleepOnPort_t)
...
#define PSHAL_MCP_DMASEND	_IOWR(PSHAL_GROUP,216,PSHALMCPDMASend_t)
#define PSHAL_MCP_DMARECV	_IOWR(PSHAL_GROUP,217,PSHALMCPDMARecv_t)
#define PSHAL_MCP_MARK_INTR_ON_PORT _IOWR(PSHAL_GROUP,218,PSHALMCPSleepOnPort_t)
#define PSHAL_MCP_GETINFOCOUNTER    _IOWR(PSHAL_GROUP,219,PSHALInfoCounter_t)
