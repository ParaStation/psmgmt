 ...
 * @see logger_print()
 */
#define PSID_log(...) logger_print(PSID_logger, -1, __VA_ARGS__)

#define PSID_dbg(...) logger_print(PSID_logger, __VA_ARGS__)

#define PSID_flog(...) logger_funcprint(PSID_logger, __func__, -1, __VA_ARGS__)

#define PSID_fdbg(...) logger_funcprint(PSID_logger, __func__, __VA_ARGS__)
