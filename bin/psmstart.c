 ...
 * All rights reserved.
 *
 * $Id: psmstart.c,v 1.1 2002/08/01 16:59:34 eicker Exp $
 *
 */
/**
...
static char vcid[] __attribute__(( unused )) = "$Id: psmstart.c,v 1.1 2002/08/01 16:59:34 eicker Exp $";
...
int main(int argc, char *argv[])
{
	...
	PSE_spawnTasks(1, -1, -1, argc, argv);
