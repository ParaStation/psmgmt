...
/**
 * @brief Propagate environment parts to be used by executables
 *
 * Some parts of the environment might have to be propagated to
 * kvsprovider and spawner in order to be passed to specific
 * executables during spawning. This is needed for the --envlist and
 * -envlist options of mpiexec. All information required to setup
 * this part of the environment is expected to be in the configuration
 * @a conf parsed from the command-line arguments.
 *
 * @param conf Configuration as identified from command-line options
 *
 * @return No return value
