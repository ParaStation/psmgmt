...
psconfig -q -D -- set 'defaults:psid' 'AccountPollInterval' '0'
...
psconfig -q -D -- setList 'defaults:psid' 'AvailableHardwareTypes' 'ethernet' 'p4sock'
...
psconfig -q -D -- set 'defaults:psid' 'HandleOldBins' 'no'
psconfig -q -D -- set 'defaults:psid' 'InstallDirectory' '/opt/parastation'
psconfig -q -D -- set 'defaults:psid' 'IsStarter' 'yes'
psconfig -q -D -- set 'defaults:psid' 'KillDelay' '5'
psconfig -q -D -- setList 'defaults:psid' 'LoadPlugins' 'pspmi' 'psslurm'
...
psconfig -q -- setPointerList 'defaults:psid' 'RessourceLimits.' 'defaults:ressourcelimits'
