 ...
 *
 * @warning The process list is gathered using @ref updateProcSnapshot()
 * which ignores root processes by default. This behavior can be
 * adjusted globally by chaning @ref IGNORE_ROOT_PROCESSES configuration
 * option's default.
 *
