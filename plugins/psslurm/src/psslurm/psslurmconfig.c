...
const ConfDef_t cgroupDef[] =
{
	...
	"string",
	"no",
	"constrain the jobs kernel memory usage" },
    { "MaxKmemPercent", 1,
	"float",
	"100.0",
	"constrain the jobs kernel memory usage to this percentage" },
    { "MinKmemSpace", 1,
	"int",
	"30",
	"constrain the jobs kernel memory usage" },
	...
	"float",
	"100.0",
	"constrain the jobs RAM usage in percent of allocated mem" },
    { "ConstrainRAMSpace", 0,
	"string",
	"no",
	...
	"float",
	"100.0",
	"upper limit in percent of total RAM" },
    { "ConstrainSwapSpace", 0,
	"string",
	"no",
	"constrain the jobs swap usage" },
    { "AllowedSwapSpace", 1,
	"float",
	"0",
	"constrain the jobs swap usage in percent of allocated mem" },
    { "MaxSwapPercent", 1,
	"float",
	"100.0",
	"upper limit in percent of total RAM" },
