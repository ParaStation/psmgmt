...
for p in [x.strip() for x in os.environ["PSTEST_PARTITIONS"].split()]:
	...
	try:
		...
		Assert(4096 == result[40][1], p)

		Assert(0 == result[41][0], p)
		Assert(268435456 == result[41][1], p)

		Assert(0 == result[42][0], p)
		Assert(8192 == result[42][1], p)

		Assert(0 == result[43][0], p)
		Assert(536870912 == result[43][1], p)

		Assert(0 == result[44][0], p)
		Assert(16384 == result[44][1], p)

		Assert(0 == result[45][0], p)
		Assert(1073741824 == result[45][1], p)

		Assert(0 == result[46][0], p)
		Assert(32768 == result[46][1], p)

		Assert(0 == result[47][0], p)
		Assert(2147483648 == result[47][1], p)
