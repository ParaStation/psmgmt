...
for p in [x.strip() for x in os.environ["PSTEST_PARTITIONS"].split()]:
	...
	try:
		...
		Assert(1 == result[8][1], p)

		Assert(1 == result[9][0], p)
		Assert(65536 == result[9][1], p)

		Assert(1 == result[10][0], p)
		Assert(2 == result[10][1], p)

		Assert(1 == result[11][0], p)
		Assert(131072 == result[11][1], p)
		...
		Assert(64 == result[20][1], p)

		Assert(0 == result[21][0], p)
		Assert(4194304 == result[21][1], p)

		Assert(0 == result[22][0], p)
		Assert(128 == result[22][1], p)

		Assert(0 == result[23][0], p)
		Assert(8388608 == result[23][1], p)

		Assert(1 == result[24][0], p)
		Assert(16 == result[24][1], p)

		Assert(1 == result[25][0], p)
		Assert(1048576 == result[25][1], p)

		Assert(1 == result[26][0], p)
		Assert(32 == result[26][1], p)

		Assert(1 == result[27][0], p)
		Assert(2097152 == result[27][1], p)
		...
		Assert(1024 == result[36][1], p)

		Assert(0 == result[37][0], p)
		Assert(67108864 == result[37][1], p)

		Assert(0 == result[38][0], p)
		Assert(2048 == result[38][1], p)

		Assert(0 == result[39][0], p)
		Assert(134217728 == result[39][1], p)

		Assert(1 == result[40][0], p)
		Assert(256 == result[40][1], p)

		Assert(1 == result[41][0], p)
		Assert(16777216 == result[41][1], p)
		...
		Assert(32768 == result[54][1], p)

		Assert(0 == result[55][0], p)
		Assert(2147483648 == result[55][1], p)
