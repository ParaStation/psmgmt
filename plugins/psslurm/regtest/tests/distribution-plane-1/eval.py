...
for p in helper.partitions():
	...
	try:
		...
		test.check(64 == result[13][1], p)

		test.check(0 == result[14][0], p)
		test.check(128 == result[14][1], p)
		...
		test.check(256 == result[17][1], p)

		test.check(0 == result[18][0], p)
		test.check(512 == result[18][1], p)
		...
		test.check(4096 == result[25][1], p)

		test.check(0 == result[26][0], p)
		test.check(8192 == result[26][1], p)
		...
		test.check(65536 == result[33][1], p)

		test.check(0 == result[34][0], p)
		test.check(131072 == result[34][1], p)
		...
		test.check(262144 == result[37][1], p)
		...
		test.check(1048576 == result[41][1], p)

		test.check(0 == result[42][0], p)
		test.check(2097152 == result[42][1], p)
		...
		test.check(4194304 == result[45][1], p)

		test.check(0 == result[46][0], p)
		test.check(8388608 == result[46][1], p)
		...
		test.check(67108864 == result[53][1], p)

		test.check(0 == result[54][0], p)
		test.check(134217728 == result[54][1], p)
		...
		test.check(536870912 == result[58][1], p)
