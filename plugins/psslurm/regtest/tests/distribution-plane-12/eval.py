...
for p in [x.strip() for x in os.environ["PSTEST_PARTITIONS"].split()]:
	...
	try:
		...
		Assert(512 == result[30][1], p)

		Assert(0 == result[31][0], p)
		Assert(33554432 == result[31][1], p)

		Assert(0 == result[32][0], p)
		Assert(1024 == result[32][1], p)

		Assert(0 == result[33][0], p)
		Assert(67108864 == result[33][1], p)

		Assert(0 == result[34][0], p)
		Assert(2048 == result[34][1], p)

		Assert(0 == result[35][0], p)
		Assert(134217728 == result[35][1], p)

		Assert(1 == result[36][0], p)
		Assert(64 == result[36][1], p)

		Assert(1 == result[37][0], p)
		Assert(4194304 == result[37][1], p)

		Assert(1 == result[38][0], p)
		Assert(128 == result[38][1], p)

		Assert(1 == result[39][0], p)
		Assert(8388608 == result[39][1], p)
