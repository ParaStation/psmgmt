...
for p in helper.partitions():
	...
	try:
		...
		test.check(16384 == result[52][1], p)

		test.check(0 == result[53][0], p)
		test.check(1073741824 == result[53][1], p)

		test.check(0 == result[54][0], p)
		test.check(32768 == result[54][1], p)
