...
for p in [x.strip() for x in os.environ["PSTEST_PARTITIONS"].split()]:
	...
	try:
		...
		Assert(1024 == result[35][1], p)

		Assert(0 == result[36][0], p)
		Assert(67108864 == result[36][1], p)

		Assert(0 == result[37][0], p)
		Assert(2048 == result[37][1], p)

		Assert(0 == result[38][0], p)
		Assert(134217728 == result[38][1], p)

		Assert(0 == result[39][0], p)
		Assert(4096 == result[39][1], p)

		Assert(0 == result[40][0], p)
		Assert(268435456 == result[40][1], p)

		Assert(0 == result[41][0], p)
		Assert(8192 == result[41][1], p)

		Assert(0 == result[42][0], p)
		Assert(536870912 == result[42][1], p)

		Assert(0 == result[43][0], p)
		Assert(16384 == result[43][1], p)

		Assert(0 == result[44][0], p)
		Assert(1073741824 == result[44][1], p)
