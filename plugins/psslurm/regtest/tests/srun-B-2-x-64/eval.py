...
for p in helper.partitions():
	...
	try:
		...
		print(result)
		print("[[0, 65537], [0, 16777472], [0, 65537], [0, 16777472], [0, 131074], [0, 33554944], [0, 131074], [0, 33554944], [0, 262148], [0, 67109888], [0, 262148], [0, 67109888], [0, 524296], [0, 134219776], [0, 524296], [0, 134219776], [0, 1048592], [0, 268439552], [0, 1048592], [0, 268439552], [0, 2097184], [0, 536879104], [0, 2097184], [0, 536879104], [0, 4194368], [0, 1073758208], [0, 4194368], [0, 1073758208], [0, 8388736], [0, 2147516416], [0, 8388736], [0, 2147516416], [1, 65537], [1, 16777472], [1, 65537], [1, 16777472], [1, 131074], [1, 33554944], [1, 131074], [1, 33554944], [1, 262148], [1, 67109888], [1, 262148], [1, 67109888], [1, 524296], [1, 134219776], [1, 524296], [1, 134219776], [1, 1048592], [1, 268439552], [1, 1048592], [1, 268439552], [1, 2097184], [1, 536879104], [1, 2097184], [1, 536879104], [1, 4194368], [1, 1073758208], [1, 4194368], [1, 1073758208], [1, 8388736], [1, 2147516416], [1, 8388736], [1, 2147516416]]")
...
#		test.check(65537 == result[32][1], p)

		test.check(1 == result[33][0], p)
#		test.check(16777472 == result[33][1], p)

		test.check(1 == result[34][0], p)
#		test.check(65537 == result[34][1], p)

		test.check(1 == result[35][0], p)
#		test.check(16777472 == result[35][1], p)

		test.check(1 == result[36][0], p)
#		test.check(131074 == result[36][1], p)

		test.check(1 == result[37][0], p)
#		test.check(33554944 == result[37][1], p)

		test.check(1 == result[38][0], p)
#		test.check(131074 == result[38][1], p)

		test.check(1 == result[39][0], p)
#		test.check(33554944 == result[39][1], p)

		test.check(1 == result[40][0], p)
#		test.check(262148 == result[40][1], p)

		test.check(1 == result[41][0], p)
#		test.check(67109888 == result[41][1], p)

		test.check(1 == result[42][0], p)
#		test.check(262148 == result[42][1], p)

		test.check(1 == result[43][0], p)
#		test.check(67109888 == result[43][1], p)

		test.check(1 == result[44][0], p)
#		test.check(524296 == result[44][1], p)

		test.check(1 == result[45][0], p)
#		test.check(134219776 == result[45][1], p)

		test.check(1 == result[46][0], p)
#		test.check(524296 == result[46][1], p)

		test.check(1 == result[47][0], p)
#		test.check(134219776 == result[47][1], p)

		test.check(1 == result[48][0], p)
#		test.check(1048592 == result[48][1], p)

		test.check(1 == result[49][0], p)
#		test.check(268439552 == result[49][1], p)

		test.check(1 == result[50][0], p)
#		test.check(1048592 == result[50][1], p)

		test.check(1 == result[51][0], p)
#		test.check(268439552 == result[51][1], p)

		test.check(1 == result[52][0], p)
#		test.check(2097184 == result[52][1], p)

		test.check(1 == result[53][0], p)
#		test.check(536879104 == result[53][1], p)

		test.check(1 == result[54][0], p)
#		test.check(2097184 == result[54][1], p)

		test.check(1 == result[55][0], p)
#		test.check(536879104 == result[55][1], p)

		test.check(1 == result[56][0], p)
#		test.check(4194368 == result[56][1], p)

		test.check(1 == result[57][0], p)
#		test.check(1073758208 == result[57][1], p)

		test.check(1 == result[58][0], p)
#		test.check(4194368 == result[58][1], p)

		test.check(1 == result[59][0], p)
#		test.check(1073758208 == result[59][1], p)

		test.check(1 == result[60][0], p)
#		test.check(8388736 == result[60][1], p)

		test.check(1 == result[61][0], p)
#		test.check(2147516416 == result[61][1], p)

		test.check(1 == result[62][0], p)
#		test.check(8388736 == result[62][1], p)

		test.check(1 == result[63][0], p)
#		test.check(2147516416 == result[63][1], p)
