...
for p in [x.strip() for x in os.environ["PSTEST_PARTITIONS"].split()]:
	...
	try:
		...
		Assert(16 == result[15][1], p)

		Assert(0 == result[16][0], p)
		Assert(1048576 == result[16][1], p)

		Assert(0 == result[17][0], p)
		Assert(32 == result[17][1], p)

		Assert(0 == result[18][0], p)
		Assert(2097152 == result[18][1], p)

		Assert(0 == result[19][0], p)
		Assert(64 == result[19][1], p)

		Assert(0 == result[20][0], p)
		Assert(4194304 == result[20][1], p)

		Assert(1 == result[21][0], p)
		Assert(524288 == result[21][1], p)

		Assert(1 == result[22][0], p)
		Assert(16 == result[22][1], p)

		Assert(1 == result[23][0], p)
		Assert(1048576 == result[23][1], p)

		Assert(1 == result[24][0], p)
		Assert(32 == result[24][1], p)

		Assert(1 == result[25][0], p)
		Assert(2097152 == result[25][1], p)
		...
		Assert(256 == result[30][1], p)

		Assert(0 == result[31][0], p)
		Assert(16777216 == result[31][1], p)

		Assert(0 == result[32][0], p)
		Assert(512 == result[32][1], p)

		Assert(0 == result[33][0], p)
		Assert(33554432 == result[33][1], p)

		Assert(0 == result[34][0], p)
		Assert(1024 == result[34][1], p)

		Assert(1 == result[35][0], p)
		Assert(128 == result[35][1], p)

		Assert(1 == result[36][0], p)
		Assert(8388608 == result[36][1], p)

		Assert(1 == result[37][0], p)
		Assert(256 == result[37][1], p)

		Assert(1 == result[38][0], p)
		Assert(16777216 == result[38][1], p)
		...
		Assert(4096 == result[45][1], p)

		Assert(0 == result[46][0], p)
		Assert(268435456 == result[46][1], p)

		Assert(0 == result[47][0], p)
		Assert(8192 == result[47][1], p)

		Assert(0 == result[48][0], p)
		Assert(536870912 == result[48][1], p)

		Assert(1 == result[49][0], p)
		Assert(67108864 == result[49][1], p)

		Assert(1 == result[50][0], p)
		Assert(2048 == result[50][1], p)

		Assert(1 == result[51][0], p)
		Assert(134217728 == result[51][1], p)
