...
for p in helper.partitions():
	...
	try:
		...
		test.check(1 == result[13][1], p)

		test.check(1 == result[14][0], p)
		test.check(2 == result[14][1], p)
		...
		test.check(64 == result[19][1], p)

		test.check(1 == result[20][0], p)
		test.check(128 == result[20][1], p)

		test.check(1 == result[21][0], p)
		test.check(256 == result[21][1], p)

		test.check(1 == result[22][0], p)
		test.check(512 == result[22][1], p)

		test.check(1 == result[23][0], p)
		test.check(1024 == result[23][1], p)

		test.check(1 == result[24][0], p)
		test.check(2048 == result[24][1], p)
		...
		test.check(8192 == result[39][1], p)

		test.check(1 == result[40][0], p)
		test.check(16384 == result[40][1], p)

		test.check(1 == result[41][0], p)
		test.check(32768 == result[41][1], p)

		test.check(1 == result[42][0], p)
		test.check(65536 == result[42][1], p)

		test.check(1 == result[43][0], p)
		test.check(131072 == result[43][1], p)

		test.check(1 == result[44][0], p)
		test.check(262144 == result[44][1], p)

		test.check(1 == result[45][0], p)
		test.check(524288 == result[45][1], p)

		test.check(1 == result[46][0], p)
		test.check(1048576 == result[46][1], p)

		test.check(1 == result[47][0], p)
		test.check(2097152 == result[47][1], p)

		test.check(1 == result[48][0], p)
		test.check(4194304 == result[48][1], p)

		test.check(1 == result[49][0], p)
		test.check(8388608 == result[49][1], p)
		...
		test.check(268435456 == result[54][1], p)

		test.check(0 == result[55][0], p)
		test.check(536870912 == result[55][1], p)

		test.check(0 == result[56][0], p)
		test.check(1073741824 == result[56][1], p)

		test.check(0 == result[57][0], p)
		test.check(2147483648 == result[57][1], p)
