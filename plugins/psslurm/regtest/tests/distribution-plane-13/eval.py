...
for p in helper.partitions():
	...
	try:
		...
		test.check(2097152 == result[11][1], p)
		...
		test.check(65536 == result[14][1], p)

		test.check(1 == result[15][0], p)
		test.check(2 == result[15][1], p)

		test.check(1 == result[16][0], p)
		test.check(131072 == result[16][1], p)
		...
		test.check(524288 == result[20][1], p)

		test.check(1 == result[21][0], p)
		test.check(16 == result[21][1], p)

		test.check(1 == result[22][0], p)
		test.check(1048576 == result[22][1], p)

		test.check(1 == result[23][0], p)
		test.check(32 == result[23][1], p)

		test.check(1 == result[24][0], p)
		test.check(2097152 == result[24][1], p)
