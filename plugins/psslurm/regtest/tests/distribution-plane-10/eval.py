...
for p in helper.partitions():
	...
	try:
		...
		test.check(65536 == result[11][1], p)
		...
		test.check(8388608 == result[25][1], p)

		test.check(0 == result[26][0], p)
		test.check(256 == result[26][1], p)

		test.check(0 == result[27][0], p)
		test.check(16777216 == result[27][1], p)

		test.check(0 == result[28][0], p)
		test.check(512 == result[28][1], p)

		test.check(0 == result[29][0], p)
		test.check(33554432 == result[29][1], p)

		test.check(1 == result[30][0], p)
		test.check(32 == result[30][1], p)

		test.check(1 == result[31][0], p)
		test.check(2097152 == result[31][1], p)

		test.check(1 == result[32][0], p)
		test.check(64 == result[32][1], p)

		test.check(1 == result[33][0], p)
		test.check(4194304 == result[33][1], p)

		test.check(1 == result[34][0], p)
		test.check(128 == result[34][1], p)
