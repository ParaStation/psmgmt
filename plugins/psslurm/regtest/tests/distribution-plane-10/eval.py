...
for p in [x.strip() for x in os.environ["PSTEST_PARTITIONS"].split()]:
	...
	try:
		...
		Assert(8388608 == result[25][1], p)

		Assert(0 == result[26][0], p)
		Assert(256 == result[26][1], p)

		Assert(0 == result[27][0], p)
		Assert(16777216 == result[27][1], p)

		Assert(0 == result[28][0], p)
		Assert(512 == result[28][1], p)

		Assert(0 == result[29][0], p)
		Assert(33554432 == result[29][1], p)

		Assert(1 == result[30][0], p)
		Assert(32 == result[30][1], p)

		Assert(1 == result[31][0], p)
		Assert(2097152 == result[31][1], p)

		Assert(1 == result[32][0], p)
		Assert(64 == result[32][1], p)

		Assert(1 == result[33][0], p)
		Assert(4194304 == result[33][1], p)

		Assert(1 == result[34][0], p)
		Assert(128 == result[34][1], p)
		...
		Assert(268435456 == result[45][1], p)

		Assert(0 == result[46][0], p)
		Assert(8192 == result[46][1], p)

		Assert(0 == result[47][0], p)
		Assert(536870912 == result[47][1], p)

		Assert(0 == result[48][0], p)
		Assert(16384 == result[48][1], p)

		Assert(0 == result[49][0], p)
		Assert(1073741824 == result[49][1], p)

		Assert(1 == result[50][0], p)
		Assert(1024 == result[50][1], p)

		Assert(1 == result[51][0], p)
		Assert(67108864 == result[51][1], p)

		Assert(1 == result[52][0], p)
		Assert(2048 == result[52][1], p)

		Assert(1 == result[53][0], p)
		Assert(134217728 == result[53][1], p)
