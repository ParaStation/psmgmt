...
for p in helper.partitions():
	...
	try:
		...
		test.check(1 == result[10][1], p)

		test.check(1 == result[11][0], p)
		test.check(2 == result[11][1], p)
		...
		test.check(33554432 == result[45][1], p)
		...
		test.check(268435456 == result[48][1], p)
