...
for p in [x.strip() for x in os.environ["PSTEST_PARTITIONS"].split()]:
	...
	try:
		...
		Assert(1 == result[23][1], p)

		Assert(1 == result[24][0], p)
		Assert(65536 == result[24][1], p)

		Assert(1 == result[25][0], p)
		Assert(2 == result[25][1], p)

		Assert(1 == result[26][0], p)
		Assert(131072 == result[26][1], p)

		Assert(1 == result[27][0], p)
		Assert(4 == result[27][1], p)

		Assert(1 == result[28][0], p)
		Assert(262144 == result[28][1], p)

		Assert(1 == result[29][0], p)
		Assert(8 == result[29][1], p)

		Assert(1 == result[30][0], p)
		Assert(524288 == result[30][1], p)

		Assert(1 == result[31][0], p)
		Assert(16 == result[31][1], p)

		Assert(1 == result[32][0], p)
		Assert(1048576 == result[32][1], p)

		Assert(1 == result[33][0], p)
		Assert(32 == result[33][1], p)

		Assert(1 == result[34][0], p)
		Assert(2097152 == result[34][1], p)

		Assert(1 == result[35][0], p)
		Assert(64 == result[35][1], p)

		Assert(1 == result[36][0], p)
		Assert(4194304 == result[36][1], p)

		Assert(1 == result[37][0], p)
		Assert(128 == result[37][1], p)

		Assert(1 == result[38][0], p)
		Assert(8388608 == result[38][1], p)

		Assert(1 == result[39][0], p)
		Assert(256 == result[39][1], p)

		Assert(1 == result[40][0], p)
		Assert(16777216 == result[40][1], p)

		Assert(1 == result[41][0], p)
		Assert(512 == result[41][1], p)

		Assert(1 == result[42][0], p)
		Assert(33554432 == result[42][1], p)

		Assert(1 == result[43][0], p)
		Assert(1024 == result[43][1], p)

		Assert(1 == result[44][0], p)
		Assert(67108864 == result[44][1], p)
		...
		Assert(4096 == result[47][1], p)

		Assert(0 == result[48][0], p)
		Assert(268435456 == result[48][1], p)

		Assert(0 == result[49][0], p)
		Assert(8192 == result[49][1], p)

		Assert(0 == result[50][0], p)
		Assert(536870912 == result[50][1], p)

		Assert(0 == result[51][0], p)
		Assert(16384 == result[51][1], p)

		Assert(0 == result[52][0], p)
		Assert(1073741824 == result[52][1], p)

		Assert(0 == result[53][0], p)
		Assert(32768 == result[53][1], p)

		Assert(0 == result[54][0], p)
		Assert(2147483648 == result[54][1], p)
