...
for p in helper.partitions():
	...
	try:
		...
		test.check(1 == result[2][0], p)
		test.check(1 == result[2][1], p)

		test.check(1 == result[3][0], p)
		test.check(2 == result[3][1], p)

		test.check(0 == result[4][0], p)
		test.check(4 == result[4][1], p)

		test.check(0 == result[5][0], p)
		test.check(8 == result[5][1], p)
		...
		test.check(1 == result[10][0], p)
		test.check(16 == result[10][1], p)

		test.check(1 == result[11][0], p)
		test.check(32 == result[11][1], p)

		test.check(0 == result[12][0], p)
		test.check(64 == result[12][1], p)

		test.check(0 == result[13][0], p)
		test.check(128 == result[13][1], p)
		...
		test.check(4096 == result[26][1], p)

		test.check(1 == result[27][0], p)
		test.check(8192 == result[27][1], p)

		test.check(0 == result[28][0], p)
		test.check(16384 == result[28][1], p)
		...
		test.check(131072 == result[35][1], p)

		test.check(0 == result[36][0], p)
		test.check(262144 == result[36][1], p)

		test.check(0 == result[37][0], p)
		test.check(524288 == result[37][1], p)
		...
		test.check(16777216 == result[50][1], p)

		test.check(1 == result[51][0], p)
		test.check(33554432 == result[51][1], p)

		test.check(0 == result[52][0], p)
		test.check(67108864 == result[52][1], p)

		test.check(0 == result[53][0], p)
		test.check(134217728 == result[53][1], p)
