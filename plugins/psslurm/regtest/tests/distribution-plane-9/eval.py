...
for p in [x.strip() for x in os.environ["PSTEST_PARTITIONS"].split()]:
	...
	try:
		...
		Assert(64 == result[21][1], p)

		Assert(0 == result[22][0], p)
		Assert(4194304 == result[22][1], p)

		Assert(0 == result[23][0], p)
		Assert(128 == result[23][1], p)

		Assert(0 == result[24][0], p)
		Assert(8388608 == result[24][1], p)

		Assert(0 == result[25][0], p)
		Assert(256 == result[25][1], p)

		Assert(0 == result[26][0], p)
		Assert(16777216 == result[26][1], p)

		Assert(1 == result[27][0], p)
		Assert(1048576 == result[27][1], p)

		Assert(1 == result[28][0], p)
		Assert(32 == result[28][1], p)

		Assert(1 == result[29][0], p)
		Assert(2097152 == result[29][1], p)
		...
		Assert(4096 == result[42][1], p)

		Assert(0 == result[43][0], p)
		Assert(268435456 == result[43][1], p)

		Assert(0 == result[44][0], p)
		Assert(8192 == result[44][1], p)

		Assert(1 == result[45][0], p)
		Assert(512 == result[45][1], p)

		Assert(1 == result[46][0], p)
		Assert(33554432 == result[46][1], p)

		Assert(1 == result[47][0], p)
		Assert(1024 == result[47][1], p)

		Assert(1 == result[48][0], p)
		Assert(67108864 == result[48][1], p)

		Assert(1 == result[49][0], p)
		Assert(2048 == result[49][1], p)

		Assert(1 == result[50][0], p)
		Assert(134217728 == result[50][1], p)
		...
		Assert(32768 == result[57][1], p)

		Assert(0 == result[58][0], p)
		Assert(2147483648 == result[58][1], p)
