...
for p in helper.partitions():
	...
	try:
		...
		test.check(2 == result[34][1], p)

		test.check(1 == result[35][0], p)
		test.check(512 == result[35][1], p)

		test.check(1 == result[36][0], p)
		test.check(4 == result[36][1], p)

		test.check(1 == result[37][0], p)
		test.check(1024 == result[37][1], p)

		test.check(1 == result[38][0], p)
		test.check(8 == result[38][1], p)

		test.check(1 == result[39][0], p)
		test.check(2048 == result[39][1], p)
