...
for p in helper.partitions():
	...
	try:
		...
		test.check(65536 == result[6][1], p)

		test.check(1 == result[7][0], p)
		test.check(2 == result[7][1], p)

		test.check(1 == result[8][0], p)
		test.check(131072 == result[8][1], p)
		...
		test.check(8 == result[11][1], p)

		test.check(0 == result[12][0], p)
		test.check(524288 == result[12][1], p)

		test.check(0 == result[13][0], p)
		test.check(16 == result[13][1], p)

		test.check(0 == result[14][0], p)
		test.check(1048576 == result[14][1], p)

		test.check(1 == result[15][0], p)
		test.check(262144 == result[15][1], p)

		test.check(1 == result[16][0], p)
		test.check(8 == result[16][1], p)

		test.check(1 == result[17][0], p)
		test.check(524288 == result[17][1], p)

		test.check(1 == result[18][0], p)
		test.check(16 == result[18][1], p)

		test.check(1 == result[19][0], p)
		test.check(1048576 == result[19][1], p)
		...
		test.check(4194304 == result[23][1], p)

		test.check(0 == result[24][0], p)
		test.check(128 == result[24][1], p)

		test.check(1 == result[25][0], p)
		test.check(32 == result[25][1], p)

		test.check(1 == result[26][0], p)
		test.check(2097152 == result[26][1], p)

		test.check(1 == result[27][0], p)
		test.check(64 == result[27][1], p)

		test.check(1 == result[28][0], p)
		test.check(4194304 == result[28][1], p)
		...
		test.check(256 == result[31][1], p)

		test.check(0 == result[32][0], p)
		test.check(16777216 == result[32][1], p)

		test.check(0 == result[33][0], p)
		test.check(512 == result[33][1], p)

		test.check(0 == result[34][0], p)
		test.check(33554432 == result[34][1], p)

		test.check(1 == result[35][0], p)
		test.check(8388608 == result[35][1], p)
		...
		test.check(1024 == result[45][1], p)

		test.check(1 == result[46][0], p)
		test.check(67108864 == result[46][1], p)

		test.check(1 == result[47][0], p)
		test.check(2048 == result[47][1], p)

		test.check(1 == result[48][0], p)
		test.check(134217728 == result[48][1], p)
		...
		test.check(8192 == result[51][1], p)

		test.check(0 == result[52][0], p)
		test.check(536870912 == result[52][1], p)

		test.check(0 == result[53][0], p)
		test.check(16384 == result[53][1], p)

		test.check(0 == result[54][0], p)
		test.check(1073741824 == result[54][1], p)

		test.check(1 == result[55][0], p)
		test.check(268435456 == result[55][1], p)

		test.check(1 == result[56][0], p)
		test.check(8192 == result[56][1], p)

		test.check(1 == result[57][0], p)
		test.check(536870912 == result[57][1], p)

		test.check(1 == result[58][0], p)
		test.check(16384 == result[58][1], p)

		test.check(1 == result[59][0], p)
		test.check(1073741824 == result[59][1], p)
